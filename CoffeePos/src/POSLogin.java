...
public class POSLogin extends JFrame {
	...
	public POSLogin() {
		...
		idPanel.add(idlaPanel);
		idPanel.add(idTfPanel);
		...
		pwPanel.add(pwlaPanel);
		pwPanel.add(pwTfPanel);
		...
		btnPanel.add(JloginBPanel);
		btnPanel.add(idPwBPanel);
		btnPanel.add(joinBpanel);
